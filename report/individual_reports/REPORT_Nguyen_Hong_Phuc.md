...
- **Student Name**: Nguyen Hong Phuc
- **Student ID**: 2A202600843
- **Date**: 2026-06-01
...
| `src/tools/lab_tools.py` | Thêm  lab tools mới: list course, |
...
6. **Registry và test đồng bộ** (`src/tools/__init__.py:11`, `tests/test_tools.py:63`):
   cập nhật số tool từ 10 lên 11, thêm test cho từng tool mới để tránh lỗi registry
